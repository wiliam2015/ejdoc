...
public class ApiDocDocsifyThemeDto {
    ...
    private List<ApiDocDocsifyThemeDto> childList;

    private List<ApiDocDocsifyThemeDto> interfaceList;
    ...
    public List<ApiDocDocsifyThemeDto> getChildList() {
        return childList;
    }

    public void setChildList(List<ApiDocDocsifyThemeDto> childList) {
        this.childList = childList;
    }

    public boolean addChild(ApiDocDocsifyThemeDto childDto){
    ...
    public boolean addInterface(ApiDocDocsifyThemeDto interfaceDto){
        if(this.interfaceList == null){
            this.interfaceList = new ArrayList<>();
        }
        return this.interfaceList.add(interfaceDto);
    }
    public List<ApiDocDocsifyThemeDto> getInterfaceList() {
        return interfaceList;
    }

    public void setInterfaceList(List<ApiDocDocsifyThemeDto> interfaceList) {
