...
| ----: | :---- | ----: |:---- |
|   **包名称:**   |  com.ejdoc.metainfo.seralize.parser.impl.javaparser.member    |   **全路径信息:**   |com.ejdoc.metainfo.seralize.parser.impl.javaparser.member.EnumMemberParse|
...
> public class EnumMemberParse extends [AbstractJavaParseMemberParse](/metaInfoSeralize/com/ejdoc/metainfo/seralize/parser/impl/javaparser/member/AbstractJavaParseMemberParse.md)     
...
|   索引  |    方法体和描述   |
| ---- | ---- |
|1|public  [EnumMemberParse](#enummemberparse)()   <br/><br/>|
...
> **1.<span id="enummemberparse">EnumMemberParse</span>**

**构造方法签名：** 

  public  [EnumMemberParse](#enummemberparse)()   
