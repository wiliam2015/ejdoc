...
public class EnumMemberParse extends AbstractJavaParseMemberParse{
    ...
    protected void parseBodyDeclarationToJavaClassMeta(JavaClassMeta javaClassMeta, MetaFileInfoDto metaFileInfo, NodeList<BodyDeclaration<?>> members, TypeDeclaration<?> typeDeclaration) {
        ...
        javaClassMeta.setEnumConstants(javaFieldMetas);
    }
    ...
    private JavaClassMeta parseFieldMember(BodyDeclaration<?> member, MetaFileInfoDto metaFileInfo, TypeDeclaration<?> typeDeclaration) {
        ...
        return enumTypeDeclarationParse.parseTypeToJavaClassMeta(metaFileInfo,compilationUnit,enumDeclaration);
    }
